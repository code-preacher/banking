...
<body style="background-color: #999999;">
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="login100-more" style="background-image: url('images/b7.jpg');"></div>

			<div class="wrap-login100 p-l-50 p-r-50 p-t-210 p-b-20">
...
<div class="container-login100-form-btn">
               ...
               ?>
				...
				<form class="login100-form validate-form" action="inc/check.php" method="post">
